...
.btn-arrow-right:before,.btn-arrow-left:before{left:-13px}.btn-arrow-right:after,.btn-arrow-left:after
{
    right:-13px
}
...
{
    top:6px;height:32px;width:32px
}
...
{
    top:4px;height:20px;width:20px
}
