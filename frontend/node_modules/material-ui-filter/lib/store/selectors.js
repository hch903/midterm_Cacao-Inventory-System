...
exports.SELECT_FIELD_TYPE = exports.ARRAY_TYPE = exports.TIME_TYPE = exports.DATE_TYPE = exports.NUMBER_TYPE = exports.STRING_TYPE = undefined;

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

exports.dynamicSort = dynamicSort;
exports.selectFilterProps = selectFilterProps;
exports.selectQueryProps = selectQueryProps;
...
var NUMBER_TYPE = exports.NUMBER_TYPE = 'number';
var DATE_TYPE = exports.DATE_TYPE = 'date';
var TIME_TYPE = exports.TIME_TYPE = 'time';
var ARRAY_TYPE = exports.ARRAY_TYPE = 'array';
var SELECT_FIELD_TYPE = exports.SELECT_FIELD_TYPE = 'select_field';
...
function dynamicSort(sortField, sortOrientation, getSourceValue) {
...
function selectFilterProps(filterName, filters) {
  var isOpen = false;
...
function selectQueryProps(query) {
  var value = '';
  var operator = void 0;
  var field = void 0;
  var type = 'string';
...
function getFilteredList(filterName, filters, list, getSourceValue) {
    ...
    if (queries) {
      for (var _iterator = queries, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        ...
        if (isSet) {
          ...
          if (type === 'date') {
            var queryDate = (0, _moment2.default)(value);
